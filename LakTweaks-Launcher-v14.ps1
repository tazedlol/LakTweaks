...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Title="LakTweaks PowerShell Tool" Height="920" Width="1500" MinHeight="760" MinWidth="1180" WindowStartupLocation="CenterScreen" ResizeMode="CanResizeWithGrip" Background="#050a0f" Foreground="#c8f5f0" FontFamily="Segoe UI">
  <Grid>
    ...
    <Grid Grid.Row="1"><Grid.ColumnDefinitions><ColumnDefinition Width="280"/><ColumnDefinition Width="*"/></Grid.ColumnDefinitions>
      ...
      <Grid Grid.Column="1" Margin="18"><Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="*"/></Grid.RowDefinitions><StackPanel Margin="0,0,0,14"><TextBlock x:Name="SectionTitle" FontSize="24" FontWeight="Bold"/><TextBlock x:Name="SectionDesc" FontSize="13" Foreground="#7ca7a2" TextWrapping="Wrap"/></StackPanel><ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto"><WrapPanel x:Name="CardPanel" ItemWidth="340"/></ScrollViewer></Grid>
    </Grid>
...
function New-Card([object]$item) {
    ...
    $outer.Width = if($script:CurrentCompact) {320} else {340}
    ...
    $title=[Windows.Controls.TextBlock]::new(); $title.Text=$item.Title; $title.FontSize=15; $title.FontWeight='Bold'; $title.Foreground=[Windows.Media.Brushes]::White; $title.TextWrapping='Wrap'; $title.MaxWidth=280; $stack.Children.Add($title)|Out-Null
...
function Show-Section([string]$key) {
    ...
    $CardPanel.ItemWidth = if($script:CurrentCompact){320}else{340}
