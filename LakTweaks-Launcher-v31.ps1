...
$script:SectionOrder = @(
    ...
    [pscustomobject]@{ Key='extreme';  Title='Extreme Mode';       Desc='Unstable lab-only strip: aggressive service, process, power, input, and content cleanup. Use only on test systems.' },
