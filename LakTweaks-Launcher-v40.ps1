...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid>
    <Grid.Resources>
      <Style TargetType="Button">
        <Setter Property="Foreground" Value="#ffffff"/>
        <Setter Property="Background" Value="#09131d"/>
    ...
    <Border Grid.Row="0" Grid.Column="0" Background="#050a0f" BorderBrush="#142b35" BorderThickness="0,0,1,1">
      <StackPanel VerticalAlignment="Center" HorizontalAlignment="Center">
        <TextBlock Text="⚡" FontSize="64" FontWeight="Black" Foreground="#00ffe7" HorizontalAlignment="Center"/>
      </StackPanel>
    </Border>
      ...
      <Grid Margin="22,0,22,0">
        ...
        <StackPanel Orientation="Vertical" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            ...
            <TextBlock Text=" v40" FontSize="32" FontWeight="Black" Foreground="#00ffe7" Margin="14,0,0,0"/>
      ...
      <Border x:Name="HomeDashboardBorder" Grid.Row="0" CornerRadius="16" Background="#071018" BorderBrush="#183542" BorderThickness="1.2" Padding="20,18">
        <Grid>
          ...
          <UniformGrid Grid.Row="0" Grid.Column="0" Rows="2" Columns="8" HorizontalAlignment="Stretch" VerticalAlignment="Center" Margin="0,0,18,6">
            <Button x:Name="SafePresetBtn"    Content="🛡&#x0a;SAFE PRESET"       Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="CompPresetBtn"    Content="🎯&#x0a;COMPETITIVE"      Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="ExtremePresetBtn" Content="☠&#x0a;EXTREME MODE"     Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="SelectAllBtn"     Content="▣&#x0a;SELECT ALL"       Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="ResetAllBtn"      Content="↻&#x0a;RESET ALL"        Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="ExportBatBtn"     Content="▤&#x0a;EXPORT BAT"       Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="RestorePointBtn"  Content="🛡&#x0a;RESTORE POINT"    Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="RetryFailedBtn"   Content="↻&#x0a;RETRY FAILED"     Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="ClearLogBtn"      Content="🧹&#x0a;CLEAR LOG"       Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="OptimizeBtn"      Content="⚡&#x0a;OPTIMIZE MY PC"   Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="LowTimerBtn"      Content="⏱&#x0a;LOW TIMER"        Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="SmartNetBtn"      Content="🌐&#x0a;SMART NETWORK"   Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="FullBackupBtn"    Content="💾&#x0a;FULL BACKUP"      Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="RestoreBackupBtn" Content="↩&#x0a;RESTORE BACKUP"   Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="RamCleanBtn"      Content="▣&#x0a;RAM CLEAN"        Padding="8" Margin="6" MinWidth="112" MinHeight="76" FontSize="11" FontWeight="Bold"/>
            <Button x:Name="ApplyBtn"         Content="▶&#x0a;APPLY SELECTED"   Padding="8" Margin="6" MinWidth="150" MinHeight="76" FontSize="12" FontWeight="Black" Foreground="#00ffe7"/>
          </UniformGrid>
    ...
    <Border x:Name="FooterBorder" Grid.Row="2" Grid.Column="1" Margin="16,0,16,12" CornerRadius="14" Background="#071018" BorderBrush="#00a7c8" BorderThickness="1.1">
      <Grid Margin="22,0">
        ...
        <Border Grid.Column="3" CornerRadius="10" BorderBrush="#00a7c8" BorderThickness="1" Padding="16,7" HorizontalAlignment="Center" VerticalAlignment="Center"><TextBlock Text="v40.0.0" Foreground="#00ffe7" FontSize="13" FontWeight="Black"/></Border>
      </Grid>
    </Border>
...
$script:CheckboxMap  = @{}
$script:SectionOrder = @(
    [pscustomobject]@{ Key='home';     Title='⌂ Home';              Desc='Dashboard: presets, backups, timer, smart network, logs, selected count, and optimizer status.' },
    [pscustomobject]@{ Key='fortnite'; Title='🎯 Fortnite FPS';      Desc='Rebuilt Pro Core: FSE-safe GameDVR off, MMCSS scheduler, Win32PrioritySeparation 26, DirectX swap effect, and clean TDR ownership.' },
    ...
    [pscustomobject]@{ Key='extreme';  Title='☠ Extreme Mode';       Desc='Lab-only strip: OneClick full service disabling, process cleanup, power strip, input lock, and content cleanup. Expect broken Windows features.' },
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v40 Home UI log cleared.' }
...
Write-Log 'v37 layout + speed mode enabled: centered 1080p footer, fixed CPU/RAM stats, lighter logging.' 'OK'
