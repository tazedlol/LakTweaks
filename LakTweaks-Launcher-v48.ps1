...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid>
      ...
      <Grid Margin="22,0,22,0">
        ...
        <StackPanel Orientation="Vertical" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            ...
            <TextBlock Text=" v48" FontSize="25" FontWeight="Black" Foreground="#00ffe7" Margin="14,0,0,0"/>
    ...
    <Grid x:Name="MainContentGrid" Grid.Row="1" Grid.Column="1" Margin="16,16,16,14">
      <Grid.RowDefinitions><RowDefinition x:Name="HomeRowDef" Height="270"/><RowDefinition x:Name="ContentRowDef" Height="*"/></Grid.RowDefinitions>

      <Border x:Name="HomeDashboardBorder" Grid.Row="0" CornerRadius="18" Background="#071018" BorderBrush="#183542" BorderThickness="1.2" Padding="18,14">
        <Grid>
          <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="112"/></Grid.ColumnDefinitions>
          <Grid.RowDefinitions><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/><RowDefinition Height="Auto"/></Grid.RowDefinitions>
          <WrapPanel Grid.Row="0" Grid.Column="0" HorizontalAlignment="Center" Margin="0,0,0,12">
            <Button x:Name="SafePresetBtn" Margin="6"/><Button x:Name="CompPresetBtn" Margin="6"/><Button x:Name="ExtremePresetBtn" Margin="6"/><Button x:Name="SelectAllBtn" Margin="6"/><Button x:Name="ResetAllBtn" Margin="6"/><Button x:Name="ExportBatBtn" Margin="6"/><Button x:Name="RestorePointBtn" Margin="6"/><Button x:Name="RetryFailedBtn" Margin="6"/><Button x:Name="ClearLogBtn" Margin="6"/><Button x:Name="OptimizeBtn" Margin="6"/>
          </WrapPanel>
          <WrapPanel Grid.Row="1" Grid.Column="0" HorizontalAlignment="Center" Margin="0,0,0,12">
            <Button x:Name="LowTimerBtn" Margin="6"/><Button x:Name="SmartNetBtn" Margin="6"/><Button x:Name="FullBackupBtn" Margin="6"/><Button x:Name="RestoreBackupBtn" Margin="6"/><Button x:Name="RamCleanBtn" Margin="6"/><Button x:Name="ApplyBtn" Margin="6"/>
          </WrapPanel>
          <Border Grid.Row="0" Grid.RowSpan="2" Grid.Column="1" BorderBrush="#1d3b49" BorderThickness="1,0,0,0" Margin="14,0,0,0">
            <StackPanel VerticalAlignment="Center" HorizontalAlignment="Center"><TextBlock Text="SELECTED" FontSize="11" Foreground="#bcecff" FontWeight="Bold" HorizontalAlignment="Center"/><TextBlock x:Name="SelectedCountText" Text="0" FontSize="34" FontWeight="Black" Foreground="#ffaa2b" HorizontalAlignment="Center"/></StackPanel>
          </Border>
          <Border Grid.Row="2" Grid.Column="0" Grid.ColumnSpan="2" CornerRadius="12" BorderThickness="1" BorderBrush="#163847" Background="#03080d" Padding="12,8">
            <Grid><Grid.ColumnDefinitions><ColumnDefinition Width="34"/><ColumnDefinition Width="*"/></Grid.ColumnDefinitions><TextBlock Text="✓" FontSize="22" FontWeight="Black" Foreground="#00ffe7" VerticalAlignment="Top" HorizontalAlignment="Center"/><TextBox x:Name="LogBox" Grid.Column="1" IsReadOnly="True" TextWrapping="Wrap" AcceptsReturn="True" VerticalScrollBarVisibility="Disabled" HorizontalScrollBarVisibility="Disabled" Background="Transparent" Foreground="#00ffe7" BorderThickness="0" FontFamily="Consolas" FontSize="11" FontWeight="Bold" Padding="0,0,8,0" MinHeight="44" MaxHeight="58" Text="LakTweaks v48 GOD UI ready. Pick a preset or select tweaks manually."/></Grid>
          </Border>
        </Grid>
      </Border>
    ...
    <Border x:Name="FooterBorder" Grid.Row="2" Grid.Column="1" Margin="16,0,16,12" CornerRadius="14" Background="#071018" BorderBrush="#00a7c8" BorderThickness="1.1">
      <Grid Margin="22,0">
        ...
        <Border Grid.Column="3" CornerRadius="10" BorderBrush="#00a7c8" BorderThickness="1" Padding="16,7" HorizontalAlignment="Center" VerticalAlignment="Center"><TextBlock Text="v48.0.0" Foreground="#00ffe7" FontSize="13" FontWeight="Black"/></Border>
      </Grid>
    </Border>
