...
function New-LakRestorePoint {
    try {
        Write-Log 'Creating restore point: LakTweaks v33 Before Apply...' 'INFO'
        Checkpoint-Computer -Description 'LakTweaks v33 Before Apply' -RestorePointType 'MODIFY_SETTINGS' -ErrorAction Stop
    ...
    foreach($item in $selected) {
        ...
        try {
            ...
            if ($proc.ExitCode -eq 0) {
                $succeeded += $item
                Write-Log ($item.Title + ' applied successfully.') 'OK'
            } else {
      ...
      <Grid Margin="18,0">
        ...
        <StackPanel Grid.Column="1" Orientation="Vertical" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            ...
            <TextBlock Text=" v34" FontSize="26" FontWeight="Bold" Foreground="#00ffe7" Margin="10,0,0,0"/>
            <Border CornerRadius="6" Padding="10,2" Margin="12,2,0,0" Background="#20103a" BorderBrush="#784dff" BorderThickness="1">
              <TextBlock Text="ELITE" FontSize="14" FontWeight="Bold" Foreground="#b98cff"/>
            </Border>
          </StackPanel>
          ...
          <Border CornerRadius="12" Padding="14,8" Margin="0,0,10,0" Background="#08141d" BorderBrush="#12313a" BorderThickness="1">
            <StackPanel Orientation="Horizontal">
              ...
              <StackPanel>
                ...
                <TextBlock Text="Ready" Foreground="#00ffe7" FontSize="10"/>
              </StackPanel>
            </StackPanel>
          </Border>
          <Border CornerRadius="12" Padding="14,8" Margin="0,0,10,0" Background="#08141d" BorderBrush="#12313a" BorderThickness="1">
            <StackPanel Orientation="Horizontal">
              ...
              <StackPanel>
                ...
                <TextBlock Text="Optimized" Foreground="#00ffe7" FontSize="10"/>
              </StackPanel>
            </StackPanel>
          </Border>
          <Border CornerRadius="12" Padding="14,8" Margin="0,0,16,0" Background="#08141d" BorderBrush="#12313a" BorderThickness="1">
            <StackPanel Orientation="Horizontal">
              ...
              <StackPanel>
                ...
                <TextBlock Text="Elevated" Foreground="#2ed573" FontSize="10"/>
              </StackPanel>
            </StackPanel>
          </Border>
        ...
        <Border Grid.Row="1" Grid.ColumnSpan="2" Margin="0,0,0,0" CornerRadius="10" BorderThickness="1" BorderBrush="#15343d" Background="#050b10" Height="52" VerticalAlignment="Top">
          <Grid>
            ...
            <TextBox x:Name="LogBox"
                     ...
                     FontWeight="Bold"
                     Padding="0,13,8,0"
                     Text="LakTweaks v34 Elite log ready. Pick a preset or select tweaks manually."/>
          </Grid>
        </Border>
      </Grid>
    </Border>
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v34 Elite log cleared.' }
...
(& $find 'ApplyBtn').Add_Click({
    ...
    $r = [System.Windows.MessageBox]::Show(
        ...
        'LakTweaks v33 Elite','YesNo','Warning')
    if ($r -ne 'Yes') { return }
    ...
    try {
        ...
        if ($result.Failed.Count -gt 0) {
            [System.Windows.MessageBox]::Show("Applied $($result.Succeeded.Count), failed $($result.Failed.Count). Check the log panel, then use RETRY FAILED if needed.", 'LakTweaks v33 Elite', 'OK', 'Warning') | Out-Null
        } else {
            [System.Windows.MessageBox]::Show("Applied $($result.Succeeded.Count) tweak(s) successfully.`nReboot your PC for full effect.", 'LakTweaks v33 Elite', 'OK', 'Information') | Out-Null
        }
    } catch {
