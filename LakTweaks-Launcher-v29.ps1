...
[
  ...
  },
  {
    ...
    "Description": "Sets Win32PrioritySeparation=26 — gives foreground app the maximum CPU time slice. Proven frametime improvement in Fortnite.",
  ...
  },
  {
    ...
    "Description": "Prevents Windows from power-throttling game processes. Direct FPS stability improvement.",
  ...
  },
  {
    ...
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "mpo_disable",
    "Title": "Disable MPO (Multiplane Overlay)",
    "Description": "Disables MPO — eliminates stutter and frame drops caused by overlay conflicts on NVIDIA GPUs. Very common Fortnite fix.",
  ...
  },
  {
    ...
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "timer_bcdedit",
    "Title": "High Resolution Timer + TSC Sync",
    "Description": "Forces 0.5ms timer resolution via bcdedit + Enhanced TSC sync. Reduces frame scheduling jitter directly.",
    "Command": ":: === Timer Resolution + TSC ===\nbcdedit /set useplatformtick yes >nul 2>&1\nbcdedit /set disabledynamictick yes >nul 2>&1\nbcdedit /set tscsyncpolicy Enhanced >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Kernel\" /v \"GlobalTimerResolutionRequests\" /t REG_DWORD /d 1 /f >nul 2>&1\necho [OK] Timer set to 0.5ms, TSC sync Enhanced"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "cpu_cstates_off",
    "Title": "Disable CPU C-States / Idle",
    "Description": "Stops CPU from entering idle states between frames — eliminates wakeup latency spikes. Biggest framettime consistency tweak.",
    "Command": ":: === Disable CPU C-States ===\nbcdedit /set useplatformclock true >nul 2>&1\nbcdedit /set disabledynamictick yes >nul 2>&1\nbcdedit /set tscsyncpolicy Enhanced >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Power\" /v \"PlatformAoAcOverride\" /t REG_DWORD /d 0 /f >nul 2>&1\npowercfg /setacvalueindex scheme_current sub_processor IDLEDISABLE 1 >nul 2>&1\npowercfg /setdcvalueindex scheme_current sub_processor IDLEDISABLE 1 >nul 2>&1\npowercfg /setactive scheme_current >nul 2>&1\necho [OK] CPU C-states and idle disabled"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "cpu_core_parking_off",
    "Title": "Disable CPU Core Parking",
    "Description": "Prevents Windows from parking CPU cores — all cores stay active and available for Fortnite.",
  ...
  },
  {
    ...
    "Description": "Eliminates GPU TDR stutters and black-screen recovery events during Fortnite. TdrDelay=60 is the safe gaming value.",
  ...
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "ntfs_lastaccess_off",
    "Title": "Disable NTFS Last Access Timestamps",
    "Description": "Stops filesystem from updating timestamps on every file read — reduces disk I/O during Fortnite asset streaming.",
    "Command": ":: === NTFS Last Access Off ===\nfsutil behavior set disableLastAccess 1 >nul 2>&1\nfsutil behavior set encryptpagingfile 0 >nul 2>&1\necho [OK] NTFS last-access timestamps disabled"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    ...
    "Description": "Disables CPU security mitigations — gives 5-15% more CPU cycles back to the game. Only use on dedicated gaming PCs.",
    "Command": ":: === Disable Spectre/Meltdown ===\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Memory Management\" /v \"FeatureSettingsOverride\" /t REG_DWORD /d 3 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Memory Management\" /v \"FeatureSettingsOverrideMask\" /t REG_DWORD /d 3 /f >nul 2>&1\nbcdedit /set isolatedcontext No >nul 2>&1\necho [OK] Spectre/Meltdown mitigations disabled"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "vbs_hvci_off",
    "Title": "Disable VBS / HVCI",
    "Description": "Disables Virtualization Based Security and Hypervisor Code Integrity — frees up CPU overhead. Confirmed FPS improvement on some systems.",
    "Command": ":: === Disable VBS / HVCI ===\nreg add \"HKLM\\\\System\\\\CurrentControlSet\\\\Control\\\\DeviceGuard\\\\Scenarios\\\\HypervisorEnforcedCodeIntegrity\" /v \"Enabled\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\DeviceGuard\" /v \"EnableVirtualizationBasedSecurity\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\CI\\\\Policy\" /v \"VerifiedAndReputablePolicyState\" /t REG_DWORD /d 0 /f >nul 2>&1\nbcdedit /set hypervisorlaunchtype off >nul 2>&1\necho [OK] VBS and HVCI disabled"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "uac_off",
    "Title": "Disable UAC",
    "Description": "Disables User Account Control prompts — reduces process elevation overhead that can stall game startup.",
  ...
  },
  {
    ...
    "Description": "DelayedAck, congestion, window size, max user port, TTL and advanced TCP parameters.",
  ...
  },
  {
    ...
    "Description": "Sets AFD send/receive window sizes and socket performance flags.",
  ...
  },
  {
    ...
    "Description": "Sets Tcpip ServiceProvider priority order for fastest DNS resolution.",
  ...
  },
  {
    ...
    "Description": "Forces DirectInput acceleration off globally and fixes mouse wheel routing.",
  ...
  },
  {
    ...
    "Category": "INPUT / MOUSE",
    "Id": "kbd_repeat",
    "Title": "Keyboard Response + Accessibility Off",
    "Description": "Max keyboard repeat speed, min delay, disables StickyKeys/ToggleKeys/FilterKeys popups.",
    "Command": ":: === Keyboard Response + Accessibility ===\nreg add \"HKCU\\\\Control Panel\\\\Keyboard\" /v \"KeyboardDelay\" /t REG_SZ /d \"0\" /f >nul 2>&1\nreg add \"HKCU\\\\Control Panel\\\\Keyboard\" /v \"KeyboardSpeed\" /t REG_SZ /d \"31\" /f >nul 2>&1\nreg add \"HKU\\\\.DEFAULT\\\\Control Panel\\\\Keyboard\" /v \"KeyboardDelay\" /t REG_SZ /d \"0\" /f >nul 2>&1\nreg add \"HKU\\\\.DEFAULT\\\\Control Panel\\\\Keyboard\" /v \"KeyboardSpeed\" /t REG_SZ /d \"31\" /f >nul 2>&1\nreg add \"HKCU\\\\Control Panel\\\\Accessibility\\\\StickyKeys\" /v \"Flags\" /t REG_SZ /d \"506\" /f >nul 2>&1\nreg add \"HKCU\\\\Control Panel\\\\Accessibility\\\\ToggleKeys\" /v \"Flags\" /t REG_SZ /d \"58\" /f >nul 2>&1\nreg add \"HKCU\\\\Control Panel\\\\Accessibility\\\\Keyboard Response\" /v \"Flags\" /t REG_SZ /d \"122\" /f >nul 2>&1\necho [OK] Keyboard response tuned and accessibility shortcuts disabled"
  },
  {
    "CategoryId": "input",
    "Category": "INPUT / MOUSE",
    "Id": "hid_usb_power_off",
    "Title": "Disable HID / USB Input Power Saving",
    "Description": "Disables all idle and suspend flags for HID and USB device parameters — keeps mice and keyboards fully awake.",
    ...
    <Border x:Name="HeaderBorder" Grid.Row="0" Background="#080f16" BorderThickness="0,0,0,1">
      <Grid Margin="22,0">
        ...
        <StackPanel Orientation="Vertical" VerticalAlignment="Center">
          ...
          <TextBlock Text="PowerShell Desktop Tuning Tool  •  v29" FontSize="11" Foreground="#5a8a85"/>
        </StackPanel>
