...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        Title="LakTweaks v42 SPACING POLISH"
  ...
  <Grid>
    ...
    <Border Grid.Row="0" Grid.Column="0" Background="#050a0f" BorderBrush="#142b35" BorderThickness="0,0,1,1">
      <Grid VerticalAlignment="Center" HorizontalAlignment="Center" Width="92" Height="92">
        <Border CornerRadius="26" Background="#07131c" BorderBrush="#00ffe7" BorderThickness="1.2" Opacity="0.95"/>
        <TextBlock Text="L" FontSize="50" FontWeight="Black" Foreground="#00ffe7" HorizontalAlignment="Center" VerticalAlignment="Center" Margin="-18,-4,0,0"/>
        <TextBlock Text="T" FontSize="42" FontWeight="Black" Foreground="#ffffff" HorizontalAlignment="Center" VerticalAlignment="Center" Margin="24,16,0,0"/>
      </Grid>
    </Border>
      ...
      <Grid Margin="22,0,22,0">
        ...
        <StackPanel Orientation="Vertical" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            <TextBlock x:Name="LogoText" Text="LAKTWEAKS" FontSize="36" FontWeight="Black" Foreground="#ffffff"/>
            <TextBlock Text=" v42" FontSize="32" FontWeight="Black" Foreground="#00ffe7" Margin="14,0,0,0"/>
    ...
    <Border x:Name="SidebarBorder" Grid.Row="1" Grid.RowSpan="2" Grid.Column="0" BorderBrush="#142b35" BorderThickness="0,0,1,0" Background="#050a0f">
      <ListBox x:Name="SidebarList" BorderThickness="0" Background="Transparent" Foreground="#c8f5f0" Margin="16,22,16,10" HorizontalContentAlignment="Stretch" ScrollViewer.HorizontalScrollBarVisibility="Disabled"/>
    </Border>

    <Grid x:Name="MainContentGrid" Grid.Row="1" Grid.Column="1" Margin="16,16,16,14">
      <Grid.RowDefinitions><RowDefinition x:Name="HomeRowDef" Height="334"/><RowDefinition x:Name="ContentRowDef" Height="*"/></Grid.RowDefinitions>

      <Border x:Name="HomeDashboardBorder" Grid.Row="0" CornerRadius="16" Background="#071018" BorderBrush="#183542" BorderThickness="1.2" Padding="26,24">
        <Grid>
          <Grid.RowDefinitions><RowDefinition Height="226"/><RowDefinition Height="78"/></Grid.RowDefinitions>
          <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="122"/></Grid.ColumnDefinitions>

          <UniformGrid Grid.Row="0" Grid.Column="0" Rows="2" Columns="8" HorizontalAlignment="Stretch" VerticalAlignment="Center" Margin="0,0,26,12">
            <Button x:Name="SafePresetBtn"    Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="CompPresetBtn"    Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ExtremePresetBtn" Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="SelectAllBtn"     Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ResetAllBtn"      Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ExportBatBtn"     Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RestorePointBtn"  Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RetryFailedBtn"   Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ClearLogBtn"      Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="OptimizeBtn"      Padding="10" Margin="8" MinWidth="146" MinHeight="104" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="LowTimerBtn"      Padding="10" Margin="8" MinWidth="152" MinHeight="76" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="SmartNetBtn"      Padding="10" Margin="8" MinWidth="198" MinHeight="76" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="FullBackupBtn"    Padding="10" Margin="8" MinWidth="182" MinHeight="76" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RestoreBackupBtn" Padding="10" Margin="8" MinWidth="198" MinHeight="76" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RamCleanBtn"      Padding="10" Margin="8" MinWidth="170" MinHeight="76" FontSize="12" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ApplyBtn"         Padding="10" Margin="8" MinWidth="214" MinHeight="76" FontSize="13" FontWeight="Black" Background="#07131c" Foreground="#00ffe7"/>
          </UniformGrid>
    ...
    <Border x:Name="FooterBorder" Grid.Row="2" Grid.Column="1" Margin="16,0,16,12" CornerRadius="14" Background="#071018" BorderBrush="#00a7c8" BorderThickness="1.1">
      <Grid Margin="22,0">
        ...
        <Border Grid.Column="3" CornerRadius="10" BorderBrush="#00a7c8" BorderThickness="1" Padding="16,7" HorizontalAlignment="Center" VerticalAlignment="Center"><TextBlock Text="v42.0.0" Foreground="#00ffe7" FontSize="13" FontWeight="Black"/></Border>
      </Grid>
    </Border>
...
function Set-UltraActionButton {
    ...
    $Button.MinHeight = if ($Wide) { 76 } else { 104 }
    $Button.MinWidth = if ($Wide) { 190 } else { 146 }
    ...
    $textBlock.HorizontalAlignment = 'Center'; $textBlock.TextAlignment = 'Center'
...
function Set-HomeDashboardVisible([bool]$visible) {
    if ($visible) {
        ...
        $HomeRowDef.Height = [Windows.GridLength]::new(334)
    } else {
...
foreach ($sec in $script:SectionOrder) {
    ...
    $ico.FontSize = 30; $ico.Foreground = Get-ColorBrush $sec.IconColor; $ico.Width = 48; $ico.VerticalAlignment = 'Center'
    $lbl = [Windows.Controls.TextBlock]::new()
    $lbl.Text = $sec.Title; $lbl.FontSize = 15; $lbl.FontWeight = 'Black'; $lbl.Foreground = [Windows.Media.Brushes]::White; $lbl.VerticalAlignment = 'Center'
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v42 Spacing Polish log cleared.' }
...
Write-Log 'v42 spacing polish enabled: larger sidebar sections, wider action cards, cleaner Home spacing, no clipped labels.' 'OK'
