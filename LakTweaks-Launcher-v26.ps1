...
[
  ...
  },
  {
    "CategoryId": "input",
    "Category": "INPUT / MOUSE",
    "Id": "inputpowersavedeepoff",
    "Title": "Deep Input Device Power Saving Off",
    "Description": "Writes broader HID and USB idle-policy flags so mice, keyboards, and USB input devices stay fully awake.",
    "Command": ":: === Deep Input Device Power Saving Off ===
for /f "tokens=*" %%u in ('reg query "HKLM\SYSTEM\CurrentControlSet\Enum\USB" /s ^| findstr /i /c:"\Device Parameters"') do (
    reg add "%%u" /v "AllowIdleIrpInD3" /t REG_DWORD /d 0 /f >nul 2>&1
    reg add "%%u" /v "SelectiveSuspendEnabled" /t REG_DWORD /d 0 /f >nul 2>&1
    reg add "%%u" /v "D3ColdSupported" /t REG_DWORD /d 0 /f >nul 2>&1
    ...
    reg add "%%u" /v "UserSetDeviceIdleEnabled" /t REG_DWORD /d 0 /f >nul 2>&1
...
echo [OK] Deep input device power saving disabled"
  },
  {
    "CategoryId": "input",
    "Category": "INPUT / MOUSE",
    "Id": "kbmresponse",
    "Title": "Keyboard / Mouse Response Pack",
    "Description": "Tightens keyboard repeat response and disables Sticky, Filter, and Toggle shortcut popups.",
    "Command": ":: === Keyboard and Mouse Response Pack ===
reg add "HKCU\Control Panel\Keyboard" /v "KeyboardDelay" /t REG_SZ /d "0" /f >nul 2>&1
reg add "HKCU\Control Panel\Keyboard" /v "KeyboardSpeed" /t REG_SZ /d "31" /f >nul 2>&1
reg add "HKCU\Control Panel\Accessibility\StickyKeys" /v "Flags" /t REG_SZ /d "506" /f >nul 2>&1
reg add "HKCU\Control Panel\Accessibility\Keyboard Response" /v "Flags" /t REG_SZ /d "122" /f >nul 2>&1
reg add "HKCU\Control Panel\Accessibility\ToggleKeys" /v "Flags" /t REG_SZ /d "58" /f >nul 2>&1
echo [OK] Keyboard and mouse response pack applied"
  },
  {
    "CategoryId": "privacy",
    "Category": "PRIVACY",
...
,
  ...
  },
  {
    ...
    "Category": "NETWORK",
    "Id": "nagle_off",
    "Title": "Disable Nagle's Algorithm (System-Wide)",
    "Description": "Disables Nagle buffering globally — packets are sent immediately, cutting TCP send latency.",
  ...
  },
  {
    ...
    "Description": "Disables RSS which can add latency on low-core-count systems or single-game workloads.",
  ...
  },
  {
    ...
    "Description": "Sets Win32PrioritySeparation to 26 — maximizes foreground app scheduling quanta for lowest input delay.",
  ...
  },
  {
    ...
    "Description": "Forces Windows timer to 0.5ms using bcdedit — drastically reduces sleep/wait granularity for smoother frames.",
    "Command": ":: === Timer Resolution 0.5ms ===\nbcdedit /set useplatformtick yes >nul 2>&1\nbcdedit /set disabledynamictick yes >nul 2>&1\nbcdedit /set tscsyncpolicy Enhanced >nul 2>&1\necho [OK] Timer resolution set to 0.5ms"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
  ...
  },
  {
    ...
    "Description": "Disables CPU security mitigations — can give 5-15%% more CPU performance. Only do this on a dedicated gaming PC.",
    "Command": ":: === Disable Spectre/Meltdown Mitigations ===\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Memory Management\" /v \"FeatureSettingsOverride\" /t REG_DWORD /d 3 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Memory Management\" /v \"FeatureSettingsOverrideMask\" /t REG_DWORD /d 3 /f >nul 2>&1\nbcdedit /set isolatedcontext No >nul 2>&1\necho [OK] Spectre/Meltdown mitigations disabled"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "fse_fullscreen",
    "Title": "Force Exclusive Fullscreen (FSE)",
    "Description": "Forces Fullscreen Exclusive mode for Fortnite — bypasses DWM compositor for lower latency.",
    "Command": ":: === Force Exclusive Fullscreen via FSE fix ===\nreg add \"HKCU\\\\System\\\\GameConfigStore\" /v \"GameDVR_FSEBehaviorMode\" /t REG_DWORD /d 2 /f >nul 2>&1\nreg add \"HKCU\\\\System\\\\GameConfigStore\" /v \"GameDVR_FSEBehavior\" /t REG_DWORD /d 2 /f >nul 2>&1\nreg add \"HKCU\\\\System\\\\GameConfigStore\" /v \"GameDVR_DXGIHonorFSEWindowsCompatible\" /t REG_DWORD /d 1 /f >nul 2>&1\nreg add \"HKCU\\\\System\\\\GameConfigStore\" /v \"GameDVR_HonorUserFSEBehaviorMode\" /t REG_DWORD /d 1 /f >nul 2>&1\necho [OK] FSE Fullscreen forced"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "dwm_accel",
    "Title": "DWM Hardware Acceleration Tweaks",
    "Description": "Disables DWM composition CPU penalties and enables hardware-only compositing.",
    "Command": ":: === DWM Acceleration ===\nreg add \"HKCU\\\\Software\\\\Microsoft\\\\Windows\\\\DWM\" /v \"AccentColor\" /t REG_DWORD /d 4292311040 /f >nul 2>&1\nreg add \"HKCU\\\\Software\\\\Microsoft\\\\Windows\\\\DWM\" /v \"ColorizationColor\" /t REG_DWORD /d 4292311040 /f >nul 2>&1\nreg add \"HKCU\\\\Software\\\\Microsoft\\\\Windows\\\\DWM\" /v \"EnableAeroPeek\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKCU\\\\Software\\\\Microsoft\\\\Windows\\\\DWM\" /v \"AlwaysHibernateThumbnails\" /t REG_DWORD /d 0 /f >nul 2>&1\necho [OK] DWM hardware acceleration tweaks applied"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "interrupt_affinity",
    "Title": "Interrupt Affinity / CPU Idle Off",
    "Description": "Disables CPU idle states (C-states) via bcdedit — keeps all cores at max frequency with no wakeup latency.",
    "Command": ":: === Disable CPU C-States / Idle ===\nbcdedit /set useplatformclock true >nul 2>&1\nbcdedit /set disabledynamictick yes >nul 2>&1\nbcdedit /set tscsyncpolicy Enhanced >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Power\" /v \"PlatformAoAcOverride\" /t REG_DWORD /d 0 /f >nul 2>&1\necho [OK] CPU idle/C-states disabled"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    ...
    "Description": "Prevents the filesystem from updating file timestamps on every read — reduces disk I/O during game asset loading.",
    "Command": ":: === Disable NTFS Last Access Time ===\nfsutil behavior set disableLastAccess 1 >nul 2>&1\nfsutil behavior set encryptpagingfile 0 >nul 2>&1\necho [OK] NTFS last-access timestamps disabled"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "sched_affinity",
    "Title": "Scheduler Affinity / NUMA Tuning",
    "Description": "Disables NUMA-aware memory balancing and thread migration which adds micro-stutters.",
    "Command": ":: === Scheduler / NUMA Tweaks ===\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\kernel\" /v \"DisableTsx\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\kernel\" /v \"GlobalTimerResolutionRequests\" /t REG_DWORD /d 1 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\kernel\" /v \"ThreadDpcEnable\" /t REG_DWORD /d 0 /f >nul 2>&1\necho [OK] Scheduler/NUMA tweaks applied"
  },
  {
    "CategoryId": "gpu",
    "Category": "GPU / NVIDIA (Lumin + MSI Util)",
    "Id": "nvidia_prerendered",
    "Title": "NVIDIA Low Latency Mode (Ultra)",
    "Description": "Sets NVIDIA pre-rendered frames to 1 and enables low latency mode via the driver registry — the single biggest NVIDIA latency tweak.",
    "Command": ":: === NVIDIA Low Latency / Pre-Rendered Frames ===\nfor /f \"tokens=*\" %%K in ('reg query \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Class\\\\{4d36e96c-e325-11ce-bfc1-08002be10318}\" /s ^| findstr /i \"HKEY_LOCAL_MACHINE\"') do (\n    reg add \"%%K\" /v \"RMPreRenderLimit\" /t REG_DWORD /d 1 /f >nul 2>&1\n    reg add \"%%K\" /v \"RMShimlessMode\" /t REG_DWORD /d 0 /f >nul 2>&1\n    reg add \"%%K\" /v \"RenderScaleApplied\" /t REG_DWORD /d 0 /f >nul 2>&1\n)\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\GraphicsDrivers\" /v \"TdrDelay\" /t REG_DWORD /d 10 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\GraphicsDrivers\" /v \"TdrDdiDelay\" /t REG_DWORD /d 10 /f >nul 2>&1\necho [OK] NVIDIA low latency mode applied"
  },
  {
    "CategoryId": "gpu",
    "Category": "GPU / NVIDIA (Lumin + MSI Util)",
    "Id": "nvidia_shader_cache",
    "Title": "NVIDIA Shader Cache Always On",
    "Description": "Forces shader cache on so Fortnite does not recompile shaders on launch — reduces stutter.",
    "Command": ":: === NVIDIA Shader Cache ===\nreg add \"HKLM\\\\SOFTWARE\\\\NVIDIA Corporation\\\\Global\\\\NVTweak\" /v \"ShaderCache\" /t REG_DWORD /d 1 /f >nul 2>&1\nreg add \"HKLM\\\\SOFTWARE\\\\NVIDIA Corporation\\\\Global\\\\NVTweak\" /v \"Perf\" /t REG_DWORD /d 1 /f >nul 2>&1\necho [OK] NVIDIA shader cache forced on"
  },
  {
    "CategoryId": "gpu",
    "Category": "GPU / NVIDIA (Lumin + MSI Util)",
    "Id": "gpu_priority_max",
    "Title": "GPU Thread Priority Max (31)",
    "Description": "Sets GPU driver service thread priority to 31 — matches Lumin Nvidia tweak.",
    "Command": ":: === GPU Thread Priority Max ===\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Services\\\\nvlddmkm\\\\Parameters\" /v \"ThreadPriority\" /t REG_DWORD /d 31 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Services\\\\nvlddmkm\\\\Parameters\" /v \"PerfLevelSrc\" /t REG_DWORD /d 8738 /f >nul 2>&1\nreg add \"HKLM\\\\SOFTWARE\\\\NVIDIA Corporation\\\\Global\\\\NVTweak\" /v \"PowerMizerDefaultAC\" /t REG_DWORD /d 1 /f >nul 2>&1\necho [OK] GPU thread priority set to 31"
  },
  {
    "CategoryId": "gpu",
    "Category": "GPU / NVIDIA (Lumin + MSI Util)",
    "Id": "gpu_tdr_off",
    "Title": "Disable GPU TDR (Timeout Detection)",
    "Description": "Disables GPU timeout detection and recovery — eliminates TDR-caused stutters and black screens during game load.",
    "Command": ":: === Disable GPU TDR ===\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\GraphicsDrivers\" /v \"TdrLevel\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\GraphicsDrivers\" /v \"TdrDelay\" /t REG_DWORD /d 60 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\GraphicsDrivers\" /v \"TdrDdiDelay\" /t REG_DWORD /d 60 /f >nul 2>&1\necho [OK] GPU TDR disabled"
  },
  {
    "CategoryId": "input",
    "Category": "INPUT / MOUSE",
    "Id": "raw_input_force",
    "Title": "Force Raw Input Globally",
    "Description": "Writes RawMouseInput and disables pointer ballistics at the system level.",
    "Command": ":: === Force Raw Input ===\nreg add \"HKCU\\\\Control Panel\\\\Mouse\" /v \"MouseSpeed\" /t REG_SZ /d \"0\" /f >nul 2>&1\nreg add \"HKCU\\\\Control Panel\\\\Mouse\" /v \"MouseThreshold1\" /t REG_SZ /d \"0\" /f >nul 2>&1\nreg add \"HKCU\\\\Control Panel\\\\Mouse\" /v \"MouseThreshold2\" /t REG_SZ /d \"0\" /f >nul 2>&1\nreg add \"HKCU\\\\Control Panel\\\\Mouse\" /v \"MouseSensitivity\" /t REG_SZ /d \"10\" /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Services\\\\mouclass\\\\Parameters\" /v \"ThreadPriority\" /t REG_DWORD /d 31 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Services\\\\kbdclass\\\\Parameters\" /v \"ThreadPriority\" /t REG_DWORD /d 31 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Services\\\\mouclass\\\\Parameters\" /v \"MouseDataQueueSize\" /t REG_DWORD /d 20 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Services\\\\kbdclass\\\\Parameters\" /v \"KeyboardDataQueueSize\" /t REG_DWORD /d 20 /f >nul 2>&1\necho [OK] Raw input fully forced"
  },
  {
    "CategoryId": "input",
    "Category": "INPUT / MOUSE",
    ...
    "Description": "Reduces DirectInput buffer sizes and polling intervals to minimize input latency in games using DInput8.",
  ...
  },
  {
    ...
    "Description": "Enables large page support for faster TLB lookups — helps Fortnite with large memory maps.",
    "Command": ":: === Large Page Support ===\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Memory Management\" /v \"LargePageMinimum\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Memory Management\" /v \"LargeSystemCache\" /t REG_DWORD /d 0 /f >nul 2>&1\necho [OK] Large page support enabled"
  },
  {
    "CategoryId": "registry",
    "Category": "REGISTRY TWEAKS",
    "Id": "cpu_idle_disable",
    "Title": "Disable CPU Idle in Registry",
    "Description": "Writes IdleMinComplexity and related keys to keep CPU from entering idle states between frames.",
    "Command": ":: === CPU Idle Disable (Registry) ===\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Power\\\\PowerSettings\\\\54533251-82be-4824-96c1-47b60b740d00\\\\943c8cb6-6f93-4227-ad87-e9a3feec08d1\" /v \"Attributes\" /t REG_DWORD /d 2 /f >nul 2>&1\npowercfg /setacvalueindex scheme_current 54533251-82be-4824-96c1-47b60b740d00 943c8cb6-6f93-4227-ad87-e9a3feec08d1 0 >nul 2>&1\npowercfg /setdcvalueindex scheme_current 54533251-82be-4824-96c1-47b60b740d00 943c8cb6-6f93-4227-ad87-e9a3feec08d1 0 >nul 2>&1\npowercfg /setactive scheme_current >nul 2>&1\necho [OK] CPU idle disabled via power settings"
  },
  {
    "CategoryId": "registry",
    "Category": "REGISTRY TWEAKS",
    ...
    "Description": "On systems with 8GB+ RAM, splits svchost processes so each service runs isolated — prevents one service stalling another.",
  ...
  },
  {
    ...
    "Category": "REGISTRY TWEAKS",
    "Id": "boot_optimize",
    "Title": "Boot Optimize / Prefetch Boot",
    "Description": "Enables boot prefetching and optimize boot for faster game-ready state after reboot.",
    "Command": ":: === Boot Optimize ===\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Memory Management\\\\PrefetchParameters\" /v \"EnableBootTrace\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKLM\\\\SOFTWARE\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\OptimalLayout\" /v \"EnableAutoLayout\" /t REG_DWORD /d 1 /f >nul 2>&1\necho [OK] Boot optimizations applied"
  },
  {
    "CategoryId": "debloat",
    "Category": "DEBLOAT (Lumin)",
    ...
    "Command": ":: === Kill Bloat Scheduled Tasks ===\nfor %%T in (\"Microsoft\\Windows\\Application Experience\\Microsoft Compatibility Appraiser\" \"Microsoft\\Windows\\Application Experience\\ProgramDataUpdater\" \"Microsoft\\Windows\\Application Experience\\StartupAppTask\" \"Microsoft\\Windows\\Customer Experience Improvement Program\\Consolidator\" \"Microsoft\\Windows\\Customer Experience Improvement Program\\UsbCeip\" \"Microsoft\\Windows\\Autochk\\Proxy\" \"Microsoft\\Windows\\DiskDiagnostic\\Microsoft-Windows-DiskDiagnosticDataCollector\" \"Microsoft\\Windows\\PI\\Sqm-Tasks\" \"Microsoft\\Windows\\Windows Error Reporting\\QueueReporting\" \"Microsoft\\Windows\\Feedback\\Siuf\\DmClient\" \"Microsoft\\Windows\\Feedback\\Siuf\\DmClientOnScenarioDownload\") do (\n    schtasks /Change /TN \"%%~T\" /Disable >nul 2>&1\n)\necho [OK] Bloat scheduled tasks disabled"
  },
  {
    "CategoryId": "debloat",
    "Category": "DEBLOAT (Lumin)",
    "Id": "background_process_kill",
    "Title": "Kill Background Bloat Processes",
    "Description": "Kills common background processes that consume RAM and CPU during gaming.",
    "Command": ":: === Kill Background Bloat Processes ===\nfor %%P in (OneDrive.exe Teams.exe Cortana.exe SearchApp.exe YourPhone.exe MicrosoftEdgeUpdate.exe WidgetService.exe Widgets.exe EpicGamesLauncher.exe Discord.exe) do (\n    taskkill /f /im %%P >nul 2>&1\n)\necho [OK] Background bloat processes killed"
  },
  {
    "CategoryId": "debloat",
    "Category": "DEBLOAT (Lumin)",
    "Id": "onedrive_disable",
    "Title": "Disable OneDrive",
    "Description": "Prevents OneDrive from starting and syncing during gameplay.",
    "Command": ":: === Disable OneDrive ===\nreg add \"HKLM\\\\SOFTWARE\\\\Policies\\\\Microsoft\\\\Windows\\\\OneDrive\" /v \"DisableFileSyncNGSC\" /t REG_DWORD /d 1 /f >nul 2>&1\nreg add \"HKCU\\\\Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Run\" /v \"OneDrive\" /t REG_SZ /d \"\" /f >nul 2>&1\ntaskkill /f /im OneDrive.exe >nul 2>&1\necho [OK] OneDrive disabled"
  },
  {
    "CategoryId": "debloat",
    "Category": "DEBLOAT (Lumin)",
    ...
    "Description": "Disables Cortana and search indexing overhead.",
  ...
  },
  {
    ...
    "Description": "Disables Widgets, News and Interests that consume CPU/RAM even when minimized.",
    "Command": ":: === Disable Widgets / News ===\nreg add \"HKLM\\\\SOFTWARE\\\\Policies\\\\Microsoft\\\\Dsh\" /v \"AllowNewsAndInterests\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKCU\\\\Software\\\\Microsoft\\\\Windows\\\\CurrentVersion\\\\Feeds\" /v \"ShellFeedsTaskbarViewMode\" /t REG_DWORD /d 2 /f >nul 2>&1\ntaskkill /f /im Widgets.exe >nul 2>&1\necho [OK] Widgets/News disabled"
  },
  {
    "CategoryId": "power",
    "Category": "POWER",
    "Id": "pcie_link_max",
    "Title": "PCIe Link Power Max",
    "Description": "Forces PCIe slots to maximum power/performance link state — prevents GPU from downclocking during gameplay.",
    "Command": ":: === PCIe Link Power Max ===\npowercfg /setacvalueindex scheme_current 08a26e66-ad10-4f26-b938-769c9e8f72f8 0 >nul 2>&1\npowercfg /setacvalueindex scheme_current sub_pciexpress ASPM 0 >nul 2>&1\npowercfg /setdcvalueindex scheme_current sub_pciexpress ASPM 0 >nul 2>&1\npowercfg /setactive scheme_current >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Power\\\\PowerSettings\\\\501a4d13-42af-4429-9fd1-a8218c268e20\\\\ee12f906-d277-404b-b6da-e5fa1a576df5\" /v \"Attributes\" /t REG_DWORD /d 2 /f >nul 2>&1\necho [OK] PCIe link power set to max"
  },
  {
    "CategoryId": "power",
    "Category": "POWER",
    "Id": "cpu_boost_max",
    "Title": "CPU Boost / Turbo Always On",
    "Description": "Forces CPU performance boost policy to maximum turbo on all cores at all times.",
    "Command": ":: === CPU Turbo Always On ===\npowercfg /setacvalueindex scheme_current sub_processor PERFBOOSTPOL 100 >nul 2>&1\npowercfg /setacvalueindex scheme_current sub_processor PERFBOOSTMODE 2 >nul 2>&1\npowercfg /setacvalueindex scheme_current sub_processor PROCTHROTTLEMIN 100 >nul 2>&1\npowercfg /setacvalueindex scheme_current sub_processor PROCTHROTTLEMAX 100 >nul 2>&1\npowercfg /setacvalueindex scheme_current sub_processor CPMAXCORES 100 >nul 2>&1\npowercfg /setacvalueindex scheme_current sub_processor CPMINPERFORMANCE 100 >nul 2>&1\npowercfg /setdcvalueindex scheme_current sub_processor PROCTHROTTLEMIN 100 >nul 2>&1\npowercfg /setdcvalueindex scheme_current sub_processor PROCTHROTTLEMAX 100 >nul 2>&1\npowercfg /setactive scheme_current >nul 2>&1\necho [OK] CPU turbo/boost set to maximum"
  },
  {
    "CategoryId": "power",
    "Category": "POWER",
    "Id": "usb_power_max",
    "Title": "USB Always On / No Suspend",
    "Description": "Disables USB selective suspend so mice and keyboards never lose power during gameplay.",
    "Command": ":: === USB Always On ===\npowercfg /setacvalueindex scheme_current 2a737441-1930-4402-8d77-b2bebba308a3 48e6b7a6-50f5-4782-a5d4-53bb8f07e226 0 >nul 2>&1\npowercfg /setdcvalueindex scheme_current 2a737441-1930-4402-8d77-b2bebba308a3 48e6b7a6-50f5-4782-a5d4-53bb8f07e226 0 >nul 2>&1\npowercfg /setactive scheme_current >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Services\\\\USB\" /v \"DisableSelectiveSuspend\" /t REG_DWORD /d 1 /f >nul 2>&1\necho [OK] USB always on / no suspend"
  },
  {
    "CategoryId": "power",
    "Category": "POWER",
    "Id": "hibernate_off",
    "Title": "Disable Hibernate / Hiberfile",
    "Description": "Deletes the hiberfile and disables hibernate — frees disk space and removes fast-startup delays.",
    "Command": ":: === Disable Hibernate ===\npowercfg /h off >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Power\" /v \"HibernateEnabled\" /t REG_DWORD /d 0 /f >nul 2>&1\nreg add \"HKLM\\\\SYSTEM\\\\CurrentControlSet\\\\Control\\\\Session Manager\\\\Power\" /v \"HiberbootEnabled\" /t REG_DWORD /d 0 /f >nul 2>&1\necho [OK] Hibernate disabled"
  },
  {
    "CategoryId": "power",
    "Category": "POWER",
    "Id": "display_power_off",
    "Title": "Disable Display Power Saving",
    "Description": "Disables display power saving, sleep timeouts, and monitor dimming.",
    "Command": ":: === Disable Display Power Saving ===\npowercfg /setacvalueindex scheme_current sub_video videoidle 0 >nul 2>&1\npowercfg /setdcvalueindex scheme_current sub_video videoidle 0 >nul 2>&1\npowercfg /setacvalueindex scheme_current sub_sleep standbyidle 0 >nul 2>&1\npowercfg /setdcvalueindex scheme_current sub_sleep standbyidle 0 >nul 2>&1\npowercfg /setactive scheme_current >nul 2>&1\necho [OK] Display/sleep power saving disabled"
  },
  {
    "CategoryId": "power",
    "Category": "POWER",
    ...
    "Description": "Turns off hybrid sleep, wake timers, away mode, and related sleep features on AC/DC power.",
...
echo [OK] Hybrid sleep, wake timers, and away mode disabled"
  },
  {
    ...
    "Description": "Sets disk idle timeout to never and disables common storage power-down behavior in the active plan.",
...
function Invoke-TweakCommands([object[]]$selected) {
    ...
    foreach($item in $selected) {
        ...
        try {
            # Always exit 0 — reg/bcdedit return non-zero even on success (key already exists, etc.)
            $batContent = @('@echo off','setlocal EnableExtensions EnableDelayedExpansion',$item.Command,'exit /b 0') -join [Environment]::NewLine
            ...
            # Consider it a success as long as cmd.exe itself launched and ran
            $succeeded += $item
        } catch {
            $failed += $item.Title
        } finally {
    ...
    if ($failed.Count -gt 0) {
        throw ("Could not launch tweaks: " + ($failed -join ', '))
    }
    return ,$succeeded
}
    ...
    <Border x:Name="HeaderBorder" Grid.Row="0" Background="#080f16" BorderThickness="0,0,0,1">
      <Grid Margin="22,0">
        ...
        <StackPanel Orientation="Vertical" VerticalAlignment="Center">
          ...
          <TextBlock Text="PowerShell Desktop Tuning Tool  •  v25" FontSize="11" Foreground="#5a8a85"/>
        </StackPanel>
...
(& $find 'ApplyBtn').Add_Click({
    ...
    try {
        ...
        Update-SelectedCount
        [System.Windows.MessageBox]::Show("Applied $($appliedNow.Count) tweak(s) successfully.`nReboot your PC for full effect.", 'LakTweaks', 'OK', 'Information') | Out-Null
    } catch {
