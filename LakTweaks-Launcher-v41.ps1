...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        Title="LakTweaks v41 ULTRA POLISH"
  ...
  <Grid>
      ...
      <Grid Margin="22,0,22,0">
        ...
        <StackPanel Orientation="Vertical" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            ...
            <TextBlock Text=" v41" FontSize="32" FontWeight="Black" Foreground="#00ffe7" Margin="14,0,0,0"/>
    ...
    <Border x:Name="SidebarBorder" Grid.Row="1" Grid.RowSpan="2" Grid.Column="0" BorderBrush="#142b35" BorderThickness="0,0,1,0" Background="#050a0f">
      <ListBox x:Name="SidebarList" BorderThickness="0" Background="Transparent" Foreground="#c8f5f0" Margin="10,18,10,8"/>
    </Border>

    <Grid x:Name="MainContentGrid" Grid.Row="1" Grid.Column="1" Margin="16,16,16,14">
      <Grid.RowDefinitions><RowDefinition x:Name="HomeRowDef" Height="246"/><RowDefinition x:Name="ContentRowDef" Height="*"/></Grid.RowDefinitions>

      <Border x:Name="HomeDashboardBorder" Grid.Row="0" CornerRadius="16" Background="#071018" BorderBrush="#183542" BorderThickness="1.2" Padding="20,18">
        <Grid>
          <Grid.RowDefinitions><RowDefinition Height="164"/><RowDefinition Height="64"/></Grid.RowDefinitions>
          <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="122"/></Grid.ColumnDefinitions>

          <UniformGrid Grid.Row="0" Grid.Column="0" Rows="2" Columns="8" HorizontalAlignment="Stretch" VerticalAlignment="Center" Margin="0,0,18,6">
            <Button x:Name="SafePresetBtn"    Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="CompPresetBtn"    Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ExtremePresetBtn" Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="SelectAllBtn"     Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ResetAllBtn"      Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ExportBatBtn"     Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RestorePointBtn"  Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RetryFailedBtn"   Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ClearLogBtn"      Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="OptimizeBtn"      Padding="8" Margin="7" MinWidth="118" MinHeight="86" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="LowTimerBtn"      Padding="8" Margin="7" MinWidth="132" MinHeight="62" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="SmartNetBtn"      Padding="8" Margin="7" MinWidth="170" MinHeight="62" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="FullBackupBtn"    Padding="8" Margin="7" MinWidth="155" MinHeight="62" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RestoreBackupBtn" Padding="8" Margin="7" MinWidth="170" MinHeight="62" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RamCleanBtn"      Padding="8" Margin="7" MinWidth="145" MinHeight="62" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ApplyBtn"         Padding="8" Margin="7" MinWidth="190" MinHeight="62" FontSize="12" FontWeight="Black" Background="#07131c" Foreground="#00ffe7"/>
          </UniformGrid>
    ...
    <Border x:Name="FooterBorder" Grid.Row="2" Grid.Column="1" Margin="16,0,16,12" CornerRadius="14" Background="#071018" BorderBrush="#00a7c8" BorderThickness="1.1">
      <Grid Margin="22,0">
        ...
        <Border Grid.Column="3" CornerRadius="10" BorderBrush="#00a7c8" BorderThickness="1" Padding="16,7" HorizontalAlignment="Center" VerticalAlignment="Center"><TextBlock Text="v41.0.0" Foreground="#00ffe7" FontSize="13" FontWeight="Black"/></Border>
      </Grid>
    </Border>
...
function Set-UltraActionButton {
    ...
    $Button.MinHeight = if ($Wide) { 62 } else { 86 }
    $Button.MinWidth = if ($Wide) { 170 } else { 118 }
    ...
    $iconBlock.FontSize = if ($Wide) { 23 } else { 30 }
...
function Set-HomeDashboardVisible([bool]$visible) {
    if ($visible) {
        ...
        $HomeRowDef.Height = [Windows.GridLength]::new(246)
    } else {
...
foreach ($sec in $script:SectionOrder) {
    ...
    $ico.FontSize = 24; $ico.Foreground = Get-ColorBrush $sec.IconColor; $ico.Width = 34; $ico.VerticalAlignment = 'Center'
    $lbl = [Windows.Controls.TextBlock]::new()
    $lbl.Text = $sec.Title; $lbl.FontSize = 13; $lbl.FontWeight = 'Bold'; $lbl.Foreground = [Windows.Media.Brushes]::White; $lbl.VerticalAlignment = 'Center'
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v41 Ultra Polish log cleared.' }
...
Write-Log 'v41 ultra polish enabled: premium icon system, dark action cards, Home-only dashboard, cleaner sidebar.' 'OK'
