...
[
  ...
  },
  {
    ...
    "Description": "Turns off Game Bar and capture overhead. FSE-compatible values.",
  ...
  },
  {
    ...
    "Description": "Forces Fullscreen Exclusive mode — bypasses DWM compositor for lower latency.",
    "Command": ":: === Force Exclusive Fullscreen ===\nreg add \"HKCU\\\\System\\\\GameConfigStore\" /v \"GameDVR_FSEBehaviorMode\" /t REG_DWORD /d 2 /f >nul 2>&1\nreg add \"HKCU\\\\System\\\\GameConfigStore\" /v \"GameDVR_FSEBehavior\" /t REG_DWORD /d 2 /f >nul 2>&1\nreg add \"HKCU\\\\System\\\\GameConfigStore\" /v \"GameDVR_DXGIHonorFSEWindowsCompatible\" /t REG_DWORD /d 1 /f >nul 2>&1\nreg add \"HKCU\\\\System\\\\GameConfigStore\" /v \"GameDVR_HonorUserFSEBehaviorMode\" /t REG_DWORD /d 1 /f >nul 2>&1\necho [OK] FSE Fullscreen forced"
  },
  {
    "CategoryId": "fortnite",
    "Category": "FORTNITE FPS / PERFORMANCE",
  ...
  },
  {
    ...
    "Description": "Gaming-safe memory tweaks. LargeSystemCache=0 (correct for gaming), DisablePagingExecutive=1, Spectre mitigations disabled.",
  ...
  },
  {
    ...
    "Description": "Sets Win32PrioritySeparation to 26 — maximizes foreground app quanta for lowest input delay.",
  ...
  },
  {
    ...
    "Description": "Forces Windows timer to 0.5ms — reduces sleep/wait granularity for smoother frames.",
  ...
  },
  {
    ...
    "Description": "Disables CPU security mitigations — can give 5-15% more CPU performance on gaming rigs.",
  ...
  },
  {
    ...
    "Description": "Disables CPU idle states via bcdedit — keeps all cores at max frequency with no wakeup latency.",
  ...
  },
  {
    ...
    "Description": "Prevents filesystem from updating timestamps on every read — reduces disk I/O during game loading.",
  ...
  },
  {
    ...
    "Category": "FORTNITE FPS / PERFORMANCE",
    "Id": "sched_affinity",
    "Title": "Scheduler / NUMA Tuning",
    "Description": "Enables GlobalTimerResolutionRequests and disables thread migration — reduces micro-stutters.",
  ...
  },
  {
    ...
    "Description": "Disables DWM AeroPeek and thumbnail caching — reduces compositor overhead.",
  ...
  },
  {
    ...
    "Description": "Disables Xbox and Game Bar support services plus Microsoft Gaming Services.",
  ...
  },
  {
    ...
    "Description": "Disables Defender-related services and real-time protection.",
  ...
  },
  {
    ...
    "Description": "Stops crash reporting service.",
  ...
  },
  {
    ...
    "Description": "Aggressively disables extra background services.",
    "Command": ":: === OneClick Service Debloat ===\nfor %%S in (TabletInputService RetailDemo AppVClient MapsBroker PcaSvc WbioSvc FrameServer faxsvc) do (\n    sc stop %%S >nul 2>&1\n    sc config %%S start= disabled >nul 2>&1\n)\necho [OK] OneClick extreme service debloat applied"
  },
  {
    "CategoryId": "registry",
  ...
  },
  {
    ...
    "Description": "Turns off common UI animations for snappier desktop.",
  ...
  },
  {
    ...
    "Description": "Disables Multiplane Overlay — common stutter/flicker fix on some gaming systems.",
  ...
  },
  {
    ...
    "Category": "REGISTRY TWEAKS",
    "Id": "irq_priority_gpu",
    "Title": "IRQ Priority Boost",
    "Description": "Boosts GPU and NIC IRQ priorities for reduced interrupt latency.",
  ...
  },
  {
    ...
    "Description": "Splits svchost processes on 8GB+ RAM so each service runs isolated.",
  ...
  },
  {
    ...
    "Description": "Writes idle-disable keys to power settings to keep CPU from entering idle states.",
  ...
  },
  {
    ...
    "Description": "Applies PCI latency-related interrupt settings.",
  ...
  },
  {
    ...
    "Description": "Eliminates TDR-caused stutters. Sets TdrDelay=60, TdrDdiDelay=60. This is the only tweak that owns TdrDelay.",
  ...
  },
  {
    ...
    "Description": "Sets pre-rendered frames to 1 via driver registry. Note: TdrDelay is controlled by the TDR tweak only.",
  ...
  },
  {
    ...
    "Description": "Sets GPU driver service thread priority to 31 and forces max power mode.",
  ...
  },
  {
    ...
    "Description": "Forces shader cache on so Fortnite does not recompile shaders on launch.",
  ...
  },
  {
    ...
    "Category": "PRIVACY",
    "Id": "cortana_off",
    "Title": "Disable Cortana / Bing Search",
    "Description": "Disables Cortana, Bing search, and device history.",
