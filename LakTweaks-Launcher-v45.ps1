  ...
  <Grid>
    ...
    <Border Grid.Row="0" Grid.Column="0" Background="#050a0f" BorderBrush="#142b35" BorderThickness="0,0,1,1">
      <Grid VerticalAlignment="Center" HorizontalAlignment="Center" Width="46" Height="46">
        <Border CornerRadius="13" Background="#07131c" BorderBrush="#00ffe7" BorderThickness="1.1" Opacity="0.95"/>
        <TextBlock Text="L" FontSize="25" FontWeight="Black" Foreground="#00ffe7" HorizontalAlignment="Center" VerticalAlignment="Center" Margin="-8,-1,0,0"/>
        <TextBlock Text="T" FontSize="21" FontWeight="Black" Foreground="#ffffff" HorizontalAlignment="Center" VerticalAlignment="Center" Margin="11,8,0,0"/>
      </Grid>
    </Border>
    ...
    <Grid x:Name="MainContentGrid" Grid.Row="1" Grid.Column="1" Margin="16,16,16,14">
      <Grid.RowDefinitions><RowDefinition x:Name="HomeRowDef" Height="236"/><RowDefinition x:Name="ContentRowDef" Height="*"/></Grid.RowDefinitions>

      <Border x:Name="HomeDashboardBorder" Grid.Row="0" CornerRadius="16" Background="#071018" BorderBrush="#183542" BorderThickness="1.2" Padding="18,14">
        <Grid>
          <Grid.RowDefinitions><RowDefinition Height="140"/><RowDefinition Height="62"/></Grid.RowDefinitions>
          ...
          <WrapPanel Grid.Row="0" Grid.Column="0" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="0,0,22,8">
            <Button x:Name="SafePresetBtn"    Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="CompPresetBtn"    Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ExtremePresetBtn" Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="SelectAllBtn"     Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ResetAllBtn"      Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ExportBatBtn"     Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RestorePointBtn"  Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RetryFailedBtn"   Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ClearLogBtn"      Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="OptimizeBtn"      Padding="10" Margin="6" Width="118" Height="66" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="LowTimerBtn"      Padding="10" Margin="6" Width="132" Height="52" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="SmartNetBtn"      Padding="10" Margin="6" Width="154" Height="52" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="FullBackupBtn"    Padding="10" Margin="6" Width="146" Height="52" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RestoreBackupBtn" Padding="10" Margin="6" Width="154" Height="52" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RamCleanBtn"      Padding="10" Margin="6" Width="134" Height="52" FontSize="10" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ApplyBtn"         Padding="10" Margin="6" Width="166" Height="52" FontSize="11" FontWeight="Black" Background="#07131c" Foreground="#00ffe7"/>
          </WrapPanel>
...
function Set-UltraActionButton {
    ...
    $Button.Height = if ($Wide) { 52 } else { 66 }
    $Button.Width  = if ($Wide) { 150 } else { 118 }
...
function Apply-UltraActionButtons {
    ...
    foreach($pair in @(@('SmartNetBtn',154),@('RestoreBackupBtn',164),@('ApplyBtn',166),@('FullBackupBtn',146),@('RamCleanBtn',134),@('LowTimerBtn',132))) {
        $b = & $find $pair[0]
        if ($b) { $b.Width = [double]$pair[1]; $b.Height = 52 }
    }
}
...
function Set-HomeDashboardVisible([bool]$visible) {
    if ($visible) {
        ...
        $HomeRowDef.Height = [Windows.GridLength]::new(236)
    } else {
...
foreach ($sec in $script:SectionOrder) {
    ...
    $ico.FontSize = 21; $ico.Foreground = Get-ColorBrush $sec.IconColor; $ico.Width = 34; $ico.VerticalAlignment = 'Center'
    $lbl = [Windows.Controls.TextBlock]::new()
    $lbl.Text = $sec.Title; $lbl.FontSize = 12; $lbl.FontWeight = 'Black'; $lbl.TextWrapping = 'NoWrap'; $lbl.TextTrimming = 'None'; $lbl.Foreground = [Windows.Media.Brushes]::White; $lbl.VerticalAlignment = 'Center'
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v45 Final Spacing log cleared.' }
...
Write-Log 'v45 final spacing enabled: smaller LT logo, readable sidebar names, unclipped Home action cards.' 'OK'
