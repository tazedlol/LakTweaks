  ...
  <Grid>
    ...
    <Border x:Name="FooterBorder" Grid.Row="2" BorderThickness="0,1,0,0">
      <Grid Margin="20,10">
        ...
        <Border Grid.Row="1" Grid.ColumnSpan="2" Margin="0,6,0,0" CornerRadius="10" BorderThickness="1" BorderBrush="#15343d" Background="#050b10">
          <TextBox x:Name="LogBox"
                   ...
                   FontSize="11"
                   Padding="10"
                   Text="LakTweaks v33 Elite log ready. Pick a preset or select tweaks manually."/>
        </Border>
      </Grid>
    </Border>
  </Grid>
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v33 Elite log cleared.' }
