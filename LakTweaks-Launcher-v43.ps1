...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        Title="LakTweaks v43 FINAL SPACING"
  ...
  <Grid>
    ...
    <Border Grid.Row="0" Grid.Column="0" Background="#050a0f" BorderBrush="#142b35" BorderThickness="0,0,1,1">
      <Grid VerticalAlignment="Center" HorizontalAlignment="Center" Width="74" Height="74">
        <Border CornerRadius="20" Background="#07131c" BorderBrush="#00ffe7" BorderThickness="1.1" Opacity="0.95"/>
        <TextBlock Text="L" FontSize="40" FontWeight="Black" Foreground="#00ffe7" HorizontalAlignment="Center" VerticalAlignment="Center" Margin="-14,-3,0,0"/>
        <TextBlock Text="T" FontSize="34" FontWeight="Black" Foreground="#ffffff" HorizontalAlignment="Center" VerticalAlignment="Center" Margin="18,13,0,0"/>
      </Grid>
    </Border>
      ...
      <Grid Margin="22,0,22,0">
        ...
        <StackPanel Orientation="Vertical" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            <TextBlock x:Name="LogoText" Text="LAKTWEAKS" FontSize="34" FontWeight="Black" Foreground="#ffffff"/>
            <TextBlock Text=" v43" FontSize="30" FontWeight="Black" Foreground="#00ffe7" Margin="14,0,0,0"/>
            <Border CornerRadius="8" Padding="13,4" Margin="14,4,0,0" Background="#1d1236" BorderBrush="#784dff" BorderThickness="1.2">
              <TextBlock Text="ULTIMATE" FontSize="18" FontWeight="Black" Foreground="#b98cff"/>
            </Border>
          </StackPanel>
          <TextBlock Text="ULTIMATE WINDOWS OPTIMIZER" FontSize="16" Foreground="#7fa5a6" FontWeight="SemiBold" Margin="2,10,0,0"/>
        </StackPanel>

        <StackPanel Grid.Column="1" Orientation="Horizontal" VerticalAlignment="Center">
          <Border CornerRadius="14" Padding="18,10" Margin="0,0,14,0" Background="#09131d" BorderBrush="#17313d" BorderThickness="1.2">
            <StackPanel Orientation="Horizontal"><TextBlock Text="▦" Foreground="#00a2ff" FontSize="30" Margin="0,0,12,0" VerticalAlignment="Center"/><StackPanel><TextBlock Text="Windows 11 Pro" Foreground="#ffffff" FontSize="14" FontWeight="Bold"/><TextBlock x:Name="WindowsValueText" Text="Detecting" Foreground="#00ffe7" FontSize="13" FontWeight="SemiBold"/></StackPanel></StackPanel>
          </Border>
          <Border CornerRadius="14" Padding="18,10" Margin="0,0,14,0" Background="#09131d" BorderBrush="#17313d" BorderThickness="1.2">
            <StackPanel Orientation="Horizontal"><TextBlock Text="▣" Foreground="#00ffe7" FontSize="27" Margin="0,0,12,0" VerticalAlignment="Center"/><StackPanel><TextBlock Text="CPU" Foreground="#ffffff" FontSize="14" FontWeight="Bold"/><TextBlock x:Name="CpuValueText" Text="0%" Foreground="#00ffe7" FontSize="13" FontWeight="SemiBold"/></StackPanel></StackPanel>
          </Border>
          <Border CornerRadius="14" Padding="18,10" Margin="0,0,14,0" Background="#09131d" BorderBrush="#17313d" BorderThickness="1.2">
            <StackPanel Orientation="Horizontal"><TextBlock Text="▤" Foreground="#00ffe7" FontSize="27" Margin="0,0,12,0" VerticalAlignment="Center"/><StackPanel><TextBlock Text="RAM" Foreground="#ffffff" FontSize="14" FontWeight="Bold"/><TextBlock x:Name="RamValueText" Text="0%" Foreground="#00ffe7" FontSize="13" FontWeight="SemiBold"/></StackPanel></StackPanel>
          </Border>
          <Border CornerRadius="14" Padding="18,10" Background="#09131d" BorderBrush="#17313d" BorderThickness="1.2">
            <StackPanel Orientation="Horizontal"><TextBlock Text="♙" Foreground="#00ffe7" FontSize="29" Margin="0,0,12,0" VerticalAlignment="Center"/><StackPanel><TextBlock Text="Administrator" Foreground="#ffffff" FontSize="14" FontWeight="Bold"/><TextBlock x:Name="AdminValueText" Text="Checking" Foreground="#2ed573" FontSize="13" FontWeight="SemiBold"/></StackPanel></StackPanel>
          </Border>
        </StackPanel>
      </Grid>
    </Border>
    ...
    <Border x:Name="SidebarBorder" Grid.Row="1" Grid.RowSpan="2" Grid.Column="0" BorderBrush="#142b35" BorderThickness="0,0,1,0" Background="#050a0f">
      <ListBox x:Name="SidebarList" BorderThickness="0" Background="Transparent" Foreground="#c8f5f0" Margin="14,18,12,10" HorizontalContentAlignment="Stretch" ScrollViewer.HorizontalScrollBarVisibility="Disabled"/>
    </Border>

    <Grid x:Name="MainContentGrid" Grid.Row="1" Grid.Column="1" Margin="16,16,16,14">
      <Grid.RowDefinitions><RowDefinition x:Name="HomeRowDef" Height="300"/><RowDefinition x:Name="ContentRowDef" Height="*"/></Grid.RowDefinitions>

      <Border x:Name="HomeDashboardBorder" Grid.Row="0" CornerRadius="16" Background="#071018" BorderBrush="#183542" BorderThickness="1.2" Padding="22,20">
        <Grid>
          <Grid.RowDefinitions><RowDefinition Height="190"/><RowDefinition Height="76"/></Grid.RowDefinitions>
          <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="122"/></Grid.ColumnDefinitions>

          <WrapPanel Grid.Row="0" Grid.Column="0" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="0,0,22,8">
            <Button x:Name="SafePresetBtn"    Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="CompPresetBtn"    Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ExtremePresetBtn" Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="SelectAllBtn"     Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ResetAllBtn"      Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ExportBatBtn"     Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RestorePointBtn"  Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RetryFailedBtn"   Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ClearLogBtn"      Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="OptimizeBtn"      Padding="10" Margin="6" Width="122" Height="88" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="LowTimerBtn"      Padding="10" Margin="6" Width="146" Height="64" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="SmartNetBtn"      Padding="10" Margin="6" Width="178" Height="64" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="FullBackupBtn"    Padding="10" Margin="6" Width="166" Height="64" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RestoreBackupBtn" Padding="10" Margin="6" Width="178" Height="64" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="RamCleanBtn"      Padding="10" Margin="6" Width="154" Height="64" FontSize="11" FontWeight="Bold" Background="#07131c" Foreground="#ffffff"/>
            <Button x:Name="ApplyBtn"         Padding="10" Margin="6" Width="188" Height="64" FontSize="12" FontWeight="Black" Background="#07131c" Foreground="#00ffe7"/>
          </WrapPanel>

          <StackPanel Grid.Row="0" Grid.Column="1" HorizontalAlignment="Center" VerticalAlignment="Center">
            <TextBlock Text="SELECTED" FontSize="13" Foreground="#bcecff" FontWeight="Bold" HorizontalAlignment="Center"/>
            <TextBlock x:Name="SelectedCountText" Text="0" FontSize="42" FontWeight="Black" Foreground="#ffaa2b" HorizontalAlignment="Center"/>
          </StackPanel>

          <Border Grid.Row="1" Grid.ColumnSpan="2" CornerRadius="13" BorderThickness="1.2" BorderBrush="#163847" Background="#03080d" Padding="10,6" Margin="0,2,0,0">
            <Grid>
              <Grid.ColumnDefinitions><ColumnDefinition Width="34"/><ColumnDefinition Width="*"/></Grid.ColumnDefinitions>
              <TextBlock Text="✓" FontSize="26" FontWeight="Black" Foreground="#00ffe7" VerticalAlignment="Center" HorizontalAlignment="Center"/>
              <TextBox x:Name="LogBox" Grid.Column="1" IsReadOnly="True" TextWrapping="Wrap" AcceptsReturn="True" VerticalScrollBarVisibility="Disabled" HorizontalScrollBarVisibility="Disabled" Background="Transparent" Foreground="#00ffe7" BorderThickness="0" FontFamily="Consolas" FontSize="13" FontWeight="Bold" Padding="0,2,8,0" Text="LakTweaks v43 Final Spacing ready. Pick a preset or select tweaks manually."/>
            </Grid>
          </Border>
        </Grid>
      </Border>
    ...
    <Border x:Name="FooterBorder" Grid.Row="2" Grid.Column="1" Margin="16,0,16,12" CornerRadius="14" Background="#071018" BorderBrush="#00a7c8" BorderThickness="1.1">
      <Grid Margin="22,0">
        ...
        <Border Grid.Column="3" CornerRadius="10" BorderBrush="#00a7c8" BorderThickness="1" Padding="16,7" HorizontalAlignment="Center" VerticalAlignment="Center"><TextBlock Text="v43.0.0" Foreground="#00ffe7" FontSize="13" FontWeight="Black"/></Border>
      </Grid>
    </Border>
...
function Set-UltraActionButton {
    ...
    $Button.Height = if ($Wide) { 64 } else { 88 }
    $Button.Width  = if ($Wide) { 178 } else { 122 }
    $stack = [Windows.Controls.StackPanel]::new()
    $stack.Orientation = if ($Wide) { 'Horizontal' } else { 'Vertical' }
    ...
    $textBlock.HorizontalAlignment = 'Center'; $textBlock.TextAlignment = 'Center'; $textBlock.TextWrapping = 'NoWrap'
...
function Apply-UltraActionButtons {
    ...
    foreach($pair in @(@('SmartNetBtn',178),@('RestoreBackupBtn',184),@('ApplyBtn',188),@('FullBackupBtn',166),@('RamCleanBtn',154),@('LowTimerBtn',146))) {
        $b = & $find $pair[0]
        if ($b) { $b.Width = [double]$pair[1]; $b.Height = 64 }
    }
}
...
function Set-HomeDashboardVisible([bool]$visible) {
    if ($visible) {
        ...
        $HomeRowDef.Height = [Windows.GridLength]::new(300)
    } else {
...
foreach ($sec in $script:SectionOrder) {
    ...
    $ico.FontSize = 26; $ico.Foreground = Get-ColorBrush $sec.IconColor; $ico.Width = 42; $ico.VerticalAlignment = 'Center'
    $lbl = [Windows.Controls.TextBlock]::new()
    $lbl.Text = $sec.Title; $lbl.FontSize = 14; $lbl.FontWeight = 'Black'; $lbl.TextWrapping = 'NoWrap'; $lbl.TextTrimming = 'None'; $lbl.Foreground = [Windows.Media.Brushes]::White; $lbl.VerticalAlignment = 'Center'
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v43 Final Spacing log cleared.' }
...
Write-Log 'v43 final spacing enabled: smaller LT logo, readable sidebar names, unclipped Home action cards.' 'OK'
