...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid>
      ...
      <Grid Margin="22,0,22,0">
        ...
        <StackPanel Orientation="Vertical" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            ...
            <TextBlock Text=" v38" FontSize="32" FontWeight="Black" Foreground="#00ffe7" Margin="14,0,0,0"/>
    ...
    <Grid Grid.Row="1" Grid.Column="1" Margin="16,16,16,14">
      <Grid.RowDefinitions><RowDefinition Height="210"/><RowDefinition Height="*"/></Grid.RowDefinitions>

      <Border Grid.Row="0" CornerRadius="16" Background="#071018" BorderBrush="#183542" BorderThickness="1.2" Padding="20,18">
        <Grid>
          <Grid.RowDefinitions><RowDefinition Height="112"/><RowDefinition Height="82"/></Grid.RowDefinitions>
          <Grid.ColumnDefinitions><ColumnDefinition Width="*"/><ColumnDefinition Width="122"/></Grid.ColumnDefinitions>

          <UniformGrid Grid.Row="0" Grid.Column="0" Rows="2" Columns="8" HorizontalAlignment="Stretch" VerticalAlignment="Center" Margin="0,0,18,8">
            <Button x:Name="SafePresetBtn"    Content="🛡&#x0a;SAFE PRESET"       Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="CompPresetBtn"    Content="🎯&#x0a;COMPETITIVE"      Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="ExtremePresetBtn" Content="☠&#x0a;EXTREME MODE"     Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="SelectAllBtn"     Content="▣&#x0a;SELECT ALL"       Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="ResetAllBtn"      Content="↻&#x0a;RESET ALL"        Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="ExportBatBtn"     Content="▤&#x0a;EXPORT BAT"       Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="RestorePointBtn"  Content="🛡&#x0a;RESTORE POINT"    Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="RetryFailedBtn"   Content="↻&#x0a;RETRY FAILED"     Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="ClearLogBtn"      Content="🧹&#x0a;CLEAR LOG"       Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="OptimizeBtn"      Content="⚡&#x0a;OPTIMIZE MY PC"   Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="LowTimerBtn"      Content="⏱&#x0a;LOW TIMER"        Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="SmartNetBtn"      Content="🌐&#x0a;SMART NETWORK"   Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="FullBackupBtn"    Content="💾&#x0a;FULL BACKUP"      Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="RestoreBackupBtn" Content="↩&#x0a;RESTORE BACKUP"   Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="RamCleanBtn"      Content="▣&#x0a;RAM CLEAN"        Padding="8" Margin="6" MinWidth="110" FontWeight="Bold"/>
            <Button x:Name="ApplyBtn"         Content="▶&#x0a;APPLY SELECTED"   Padding="8" Margin="6" MinWidth="110" FontWeight="Black" Foreground="#00ffe7"/>
          </UniformGrid>
          ...
          <Border Grid.Row="1" Grid.ColumnSpan="2" CornerRadius="13" BorderThickness="1.2" BorderBrush="#163847" Background="#03080d" Padding="10,8" Margin="0,4,0,0">
            <Grid>
    ...
    <Border x:Name="FooterBorder" Grid.Row="2" Grid.Column="1" Margin="16,0,16,12" CornerRadius="14" Background="#071018" BorderBrush="#00a7c8" BorderThickness="1.1">
      <Grid Margin="22,0">
        ...
        <Border Grid.Column="3" CornerRadius="10" BorderBrush="#00a7c8" BorderThickness="1" Padding="16,7" HorizontalAlignment="Center" VerticalAlignment="Center"><TextBlock Text="v38.0.0" Foreground="#00ffe7" FontSize="13" FontWeight="Black"/></Border>
      </Grid>
    </Border>
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v38 ULTIMATE log cleared.' }
