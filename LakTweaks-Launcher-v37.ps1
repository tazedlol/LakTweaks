  ...
  <Grid>
      ...
      <Grid Margin="18,0">
        ...
        <StackPanel Grid.Column="1" Orientation="Vertical" VerticalAlignment="Center">
          <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
            ...
            <TextBlock Text=" v37" FontSize="26" FontWeight="Bold" Foreground="#00ffe7" Margin="10,0,0,0"/>
    ...
    <Border x:Name="FooterBorder" Grid.Row="2" BorderThickness="0,1,0,0">
      <Grid Margin="16,7,16,7">
        ...
        <UniformGrid Grid.Row="0" Grid.Column="0" Rows="2" Columns="8" HorizontalAlignment="Center" VerticalAlignment="Center" Margin="0,0,8,0">
          <Button x:Name="SafePresetBtn"    Content="🛡  SAFE"       Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="CompPresetBtn"    Content="🎯  COMP"       Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="ExtremePresetBtn" Content="☠  EXTREME"    Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="SelectAllBtn"     Content="▣  SELECT"     Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="ResetAllBtn"      Content="↻  RESET"      Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="ExportBatBtn"     Content="▤  EXPORT"     Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="RestorePointBtn"  Content="🛡  RESTORE"    Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="RetryFailedBtn"   Content="↻  RETRY"      Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="ClearLogBtn"      Content="🧹  CLEAR LOG"  Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="OptimizeBtn"      Content="🚀  OPTIMIZE"   Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="LowTimerBtn"      Content="⏱  TIMER"      Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="SmartNetBtn"      Content="🌐  NETWORK"    Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="FullBackupBtn"    Content="💾  BACKUP"     Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="RestoreBackupBtn" Content="↩  RESTORE BK"  Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="RamCleanBtn"      Content="🧠  RAM"        Padding="8,7" Margin="4" MinWidth="116"/>
          <Button x:Name="ApplyBtn"         Content="▶  APPLY"      Padding="8,7" Margin="4" MinWidth="116" FontWeight="Bold"/>
        </UniformGrid>
        ...
        <StackPanel Grid.Row="0" Grid.Column="1" HorizontalAlignment="Right" VerticalAlignment="Center">
          ...
          <TextBlock x:Name="SelectedCountText" Text="0" FontSize="28" FontWeight="Black" HorizontalAlignment="Right"/>
        </StackPanel>

        <Border Grid.Row="1" Grid.ColumnSpan="2" CornerRadius="9" BorderThickness="1" BorderBrush="#15343d" Background="#050b10" Height="34" VerticalAlignment="Bottom">
          <Grid>
            <Grid.ColumnDefinitions><ColumnDefinition Width="Auto"/><ColumnDefinition Width="*"/></Grid.ColumnDefinitions>
            <TextBlock Text="✓" FontSize="18" FontWeight="Bold" Foreground="#00ffe7" Margin="12,0,8,0" VerticalAlignment="Center"/>
            <TextBox x:Name="LogBox"
                     ...
                     FontWeight="Bold"
                     Padding="0,8,8,0"
                     Text="LakTweaks v37 ULTIMATE ready. Pick a preset or select tweaks manually."/>
          </Grid>
        </Border>
      </Grid>
    </Border>
...
(& $find 'ClearLogBtn').Add_Click({
    if ($null -ne $LogBox) { $LogBox.Text = 'LakTweaks v37 ULTIMATE log cleared.' }
